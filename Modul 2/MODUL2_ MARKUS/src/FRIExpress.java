public class FRIExpress extends Ekspedisi//...
{
    ...
    public FRIExpress(int jumlahCabang, String pusat, float tarif, String ekspedisi,boolean pecahBelah){
    ...
    public void terima(int jumlahPaket){
        System.out.println(this.ekspedisi + " baru saja menerima paket yang masuk untuk disortis sebanyak " + jumlahPaket + " paket");
    }

    public void kirim(String tujuan){
        System.out.println(this.ekspedisi + " berhasil mengirikan paket ke tujuan " + tujuan);
    }
    
    public void kirim(String tujuan_1, String tujuan_2){
        System.out.println(this.ekspedisi + " berhasil mengirikan paket ke tujuan " + tujuan_1 + " dan " + tujuan_2);
    } 
